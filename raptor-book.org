...
**** Refactorizacion
     ...
     Antes de pasar a otra cosa, aqui tenemos la funcion nos ayuda a cortar las
     secciones por longitud (y tipo)
     ...
     sencillo: copiar todo el contenido de @c(rexp) a @c(track), modificar el tipo,
     longitud y recorren @c(rexp) @m(n) posiciones.
