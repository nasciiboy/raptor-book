...
** Sobre el libro... y otras cosas
   ...
   - [[*Regexp3 (ASCII)]] muestra como imprementar un motor de expresiones regulares
     basado en el sitema de codificacion de caracteres @A(ASCII).
...
*** Como leer el libro
    ...
    leer cualquier documento es en formato de texto plano (detro de @e(Emacs))
...
* RegExp
  ...
  En 1968, @e(Ken Thompson) pionero de Unix publico el articulo «Regular
